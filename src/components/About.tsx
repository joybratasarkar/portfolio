...
const About = () => {
  ...
  const skills = [
    { 
      ...
      items: ['Google Vertex AI', 'LangChain', 'LangGraph', 'OpenAI APIs', 'RAG Systems', 'LLM Applications', 'AI API Integration', 'Conversational AI', 'Prompt Engineering'] 
    },
    { 
      category: 'Languages & Frameworks', 
      items: ['Python', 'JavaScript', 'TypeScript', 'FastAPI', 'Angular', 'React', 'Node.js', 'Django'] 
    },
    { 
      category: 'Programming Fundamentals', 
      items: ['Data Structures & Algorithms', 'System Design', 'Problem Solving', 'API Design'] 
    },
    { 
      category: 'Infrastructure & Systems', 
      items: ['Redis', 'Celery', 'Docker', 'Microservices', 'CI/CD', 'MongoDB', 'WebSocket', 'Distributed Systems'] 
    }
  ]
  ...
  const experiences = [
    {
      ...
      description: 'Leading 4-engineer team working on multiple MVP products including a breakthrough conversational real-time AI interview platform. Architected distributed system supporting 100+ concurrent connections with <50ms WebSocket routing. Built full-stack applications integrating LLMs and AI APIs with intelligent conversation orchestration. Optimized system performance achieving <100ms audio processing and seamless user experience.'
    },
    {
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className={`text-center mb-20 transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className={`text-xl lg:text-2xl text-neutral-600 dark:text-neutral-400 max-w-4xl mx-auto leading-relaxed ${mounted ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            ...
            <span className="text-primary-600 dark:text-primary-400 font-semibold">AI expertise</span>.
            I work with LLMs, AI APIs, and modern AI tools—but I'm not a data scientist or ML researcher. I build{' '}
            <span className="text-accent-600 dark:text-accent-400 font-semibold">production applications that leverage AI intelligently</span>.
            Currently leading a 4-engineer team at Impacteers, working on{' '}
            <span className="text-primary-600 dark:text-primary-400 font-semibold">multiple MVPs</span>{' '}
            including a conversational real-time AI interview platform serving 10K+ users with sub-50ms response times.
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-white/80 via-primary-50/50 to-accent-50/30 dark:from-neutral-900/80 dark:via-primary-950/50 dark:to-accent-950/30 backdrop-blur-sm border border-primary-200/50 dark:border-primary-800/50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="prose prose-lg dark:prose-invert">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed mb-4">
                  ...
                  (Dec 2024 - Present), I lead a 4-engineer team working on{' '}
                  <span className="text-accent-600 dark:text-accent-400 font-semibold">multiple MVP products</span>.
                  My expertise is in LLMs, AI APIs, and building full-stack applications that integrate AI smartly. I architect systems for 
                  real-time speech processing, distributed WebSocket connections, multi-layer Redis architectures, and optimization that achieves &lt;100ms audio processing. 
                  I focus on making AI tools work seamlessly in production applications.
                </p>
              </div>
            </div>
